...
public class QueryActivity1 extends Activity {
	...
	public void initFoot() {
		LinearLayout query_tag = (LinearLayout) this.findViewById(R.id.foot2);
		query_tag.setOnClickListener(new View.OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(QueryActivity1.this,
						QueryActivity.class);
	...
	public class AsyncDate extends
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			preferencesUtils = new PreferencesUtils(QueryActivity1.this);
			map = (HashMap<String, Object>) preferencesUtils.getMsg("login");
			helper = new MySQLiteOpenHelper(QueryActivity1.this,
		...
		protected List<HashMap<String, String>> doInBackground(Void... params) {
			...
			cursor = database.query("budget", new String[] { "sum", "year",
					"date", "time", "category", "project", "remarks" }, null,
			...
			while (cursor.moveToNext()) {
				...
				if (cursor.getString(cursor.getColumnIndex("category")).equals(
						"收入")) {
		...
		protected void onPostExecute(List<HashMap<String, String>> result) {
			...
			sum1 = sum2 = 0;
			if (result.isEmpty()) {
				Toast.makeText(QueryActivity1.this, "赶快开始记账吧！",
